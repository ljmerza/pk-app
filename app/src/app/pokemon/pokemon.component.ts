...
export class PokemonComponent implements OnInit, OnDestroy {
	...
	disposableObj
	 ...
	 @ViewChildren('pokemonObjects') pokemonObject: QueryList<any>;
	...
	ngAfterViewInit(){
		// after ngFor renders add collapsible on pokemon group objects
		this.pokemonObject.changes.subscribe(t => {
